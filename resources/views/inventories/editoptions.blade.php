...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.inventories') }} - Edit Option
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y p-5 mb-5 flex items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="#" class="breadcrumb--active">Edit Option</a>
    </div>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y box mt-5 col-span-12 lg:col-span-12">
        ...
        <div class="p-5">
            <form action="{{ route('inventories.options.save') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-9">
                        <input type="text" placeholder="Option name..." name="option_name" id="option_name"
                            class="input w-full border" value="{{ $option->option_name }}">
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-6 mt-5">

...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.inventories') }} - {{__('app.edit_status')}}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y p-5 mb-5 flex items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="{{ route('inventories.status') }}" class="breadcrumb">{{ __('app.status_management') }}</a>
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y box mt-5 col-span-12 lg:col-span-12">
        ...
        <div class="p-5">
            <form action="{{ route('inventories.status.save') }}" method="POST" id="create_form">
                @csrf

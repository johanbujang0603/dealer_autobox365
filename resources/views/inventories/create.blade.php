...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.inventories') }} - {{ __('menu.inventories.create') }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i>
        <a href="" class="breadcrumb--active">{{ __('menu.inventories.create') }}</a> 
    </div>
    <div class="p-5">
        <div class="preview flex flex-wrap">
            <a href="{{ route('inventories.dashboard') }}" class="button tooltip mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" title="Dashboard">
                <i data-feather="home" class="w-4 h-4 xl:mr-2"></i>
                <span class="hidden xl:block">{{ __('app.dashboard') }}</span>
            </a>
            <a href="{{ route('inventories.import') }}" class="button tooltip mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" title="Import">
                <i data-feather="plus-square" class="w-4 h-4 xl:mr-2"></i>
                <span class="hidden xl:block">{{ __('app.import') }}</span>
            </a>
            <a href="{{ route('inventories.export') }}" class="button tooltip mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" title="Export">
                <i data-feather="log-out" class="w-4 h-4 xl:mr-2"></i> <span class="hidden xl:block">{{ __('app.export') }}</span>
            </a>
        </div>
    </div>
</div>

...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.tools') }} - {{ __('menu.tools.verify_phone') }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center flex-wrap border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="" class="breadcrumb--active">{{ __('menu.tools.verify_phone') }}</a> 
    </div>
</div>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-12">
        <h2 class="text-lg font-medium mr-auto">
            {{ __('tools.verify_phone') }}
        </h2>
    </div>
    <div class="intro-y col-span-12">
        <div class="box p-5 mt-5" id="verify_phone">
        </div>
    </div>
</div>

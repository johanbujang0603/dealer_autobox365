...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.tools') }} - {{ __('menu.tools.car_recog') }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center flex-wrap border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="" class="breadcrumb--active">{{ __('menu.tools.car_recog') }}</a> 
    </div>
</div>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="intro-y col-span-12">
        <div class="box p-5 mt-5" id="car_recog">
        </div>
    </div>
</div>
...
<script src="{{ asset('js/car_recog.js') }}"></script>
@endsection

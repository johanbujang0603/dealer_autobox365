...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.transactions') }} - {{__('transaction.transaction_create_new')}}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y mb-5 flex flex-wrap items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="#" class="breadcrumb--active">{{__('transaction.transaction_create_new')}}</a>
    </div>
...
<script src="{{ asset('js/transaction_form.js') }}"></script>
@endsection

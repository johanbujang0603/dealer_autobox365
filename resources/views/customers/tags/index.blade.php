...
<div class="intro-y flex flex-wrap items-center border-b">
    ...
    <div class="p-5" id="icon-button">
        <div class="preview flex flex-wrap">
            <a href="{{ route('customers.tags.create') }}"
                            ...
                            <tr>
                                ...
                                <td class="border">
                                    <div class="flex items-center">
                                        <a class="flex items-center mr-3" href="{{ route('customers.tags.edit', $tag->id) }}">
                                            <i data-feather="check-square" class="w-4 h-4 mr-1"></i> {{ __('app.edit') }}
                                        </a>
                                        <a class="flex items-center text-theme-6" href="{{ route('customers.tags.delete', $tag->id) }}" data-toggle="modal" data-target="#delete-confirmation-modal">

...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.leads') }} - {{ __('app.status_management') }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center border-b">
    ...
    <div class="p-5" id="icon-button">
        <div class="preview flex flex-wrap">
            <a href="{{ route('leads.status.create') }}"
                            ...
                            <tr>
                                ...
                                <td class="border">
                                    <div class="flex items-center">
                                        <a class="flex items-center mr-3" href="{{ route('leads.status.edit', $status->id) }}">
                                            <i data-feather="check-square" class="w-4 h-4 mr-1"></i> {{ __('app.edit') }}
                                        </a>
                                        <a class="flex items-center text-theme-6" href="{{ route('leads.status.delete', $status->id) }}">

...
<h2 class="text-lg font-medium mr-auto">
    {{ __('app.home') }} - {{ __('app.leads') }} - {{ __('app.import') }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <a href="" class="breadcrumb--active">{{ __('app.leads') }} - {{ __('app.import') }}</a> 
    </div>
    <div class="p-5">
        <div class="preview flex flex-wrap">
            ...
            <a href="{{ route('inventories.create') }}" class="button tooltip mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" title="New Lead">
...
<div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="intro-y col-span-12 lg:col-span-12">
        <div class="p-5" id="lead_import_form" data-status="{{ $running_import_job ? 'running': 'norunning' }}"
...
<script src="{{ asset('js/lead_import_form.js') }}" socket_url='{{ env('SOCKET_SERVER') }}'>
</script>
@endsection

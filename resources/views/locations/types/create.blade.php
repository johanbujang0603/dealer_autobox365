...
<h2 class="text-lg font-medium mr-auto">
    {{ __('menu.locations.locations') }} - {{__('location.create_new_type')}}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y p-5 mb-5 flex flex-wrap items-center border-b">
    ...
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="#" class="breadcrumb--active">{{__('location.create_new_type')}}</a>
    </div>
            ...
            <form action="{{ route('locations.types.save') }}" method="POST" id="create_form">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="col-span-12 lg:col-span-9">
                        <input type="text" placeholder="{{__('location.create_new_type')}}..." name="type_name" class="input w-full border">
                    </div>
                </div>
                <div class="grid grid-cols-12 gap-6 mt-5">

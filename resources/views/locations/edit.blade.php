...
<h2 class="text-lg font-medium mr-auto">
    {{ __('menu.locations.locations') }} - {{ $location->name }}
</h2>
<!-- END: Breadcrumb -->
@endsection
...
<div class="intro-y flex items-center border-b">
    <div class="-intro-x breadcrumb mr-auto hidden sm:flex p-5">
        ...
        <i data-feather="chevron-right" class="breadcrumb__icon"></i> 
        <a href="" class="breadcrumb--active">{{ $location->name }}</a> 
    </div>
</div>
@endsection
...
@section('scripts_after')
    <script src="{{ asset('js/location_form.js?mode=edit&locationId='.$location->id) }}"></script>
@endsection

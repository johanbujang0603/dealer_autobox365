    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span
                    class="font-weight-semibold">{{ __('app.inventories') }}</span> - Edit Status</h4>
...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <span class="breadcrumb-item active">Edit Status</span>
        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" placeholder="Status name..." name="status_name"
                                            class="form-control" value="{{ $status->status_name }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <select name="color" class="form-control">
                                            ...
                                            <option @if($status->color == "primary") selected @endif
                                                value="primary">primary</option>
                                            <option @if($status->color == "danger") selected @endif
                                                value="danger">danger</option>
                                            <option @if($status->color == "success") selected @endif
                                                value="success">success</option>
                                            <option @if($status->color == "warning") selected @endif
                                                value="warning">warning</option>
                                            <option @if($status->color == "info") selected @endif value="info">info
                                            </option>
                                            <option @if($status->color == "pink") selected @endif value="pink">pink
                                            </option>
                                            <option @if($status->color == "purple") selected @endif
                                                value="purple">purple</option>
                                            <option @if($status->color == "violet") selected @endif
                                                value="violet">violet</option>
                                            <option @if($status->color == "indigo") selected @endif
                                                value="indigo">indigo</option>
                                            <option @if($status->color == "blue") selected @endif value="blue">blue
                                            </option>
                                            <option @if($status->color == "teal") selected @endif value="teal">teal
                                            </option>
                                            <option @if($status->color == "green") selected @endif value="green">green
                                            </option>
                                            <option @if($status->color == "orange") selected @endif
                                                value="orange">orange</option>
                                            <option @if($status->color == "brown") selected @endif value="brown">brown
                                            </option>
                                            <option @if($status->color == "grey") selected @endif value="grey">grey
                                            </option>
                                            <option @if($status->color == "slate") selected @endif value="slate">slate
                                            </option>
                                        </select>
                                    </div>
                                </div>

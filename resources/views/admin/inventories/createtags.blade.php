    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span
                    class="font-weight-semibold">{{ __('app.inventories') }}</span> - Create New Tag</h4>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
        </div>

        {{--  <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <a href="{{ route('admin.inventories.tags.create') }}" class="btn btn-link btn-float font-size-sm
    ...
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <a href="{{ route('admin.inventories.index') }}" class="breadcrumb-item"><i class="fas fa-car mr-2"></i>
                Inventories</a>
            <a href="{{ route('admin.inventories.tags') }}" class="breadcrumb-item"><i class="fas fa-car mr-2"></i> Tag
                Management</a>
            <span class="breadcrumb-item active">Create New Tag</span>
        </div>

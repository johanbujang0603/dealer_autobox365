...
var DateTimePickers = function() {
    ...
    var _componentDaterange = function() {
        ...
        $('.daterange-predefined').daterangepicker(
            {
                ...
                ranges: {
                    ...
                    'Last a Week': [moment().subtract(6, 'days'), moment()],
        ...
        // Inside button
        //
        let params = getParams(thisScript.src)
        // Initialize with options
        $('.daterange-ranges').daterangepicker(
            ...
            function(start, end) {
                ...
                // var query = "start=" + start.format('YYYY-MM-DD') + "&" + end.format('YYYY-MM-DD')
                let url = updateQueryStringParameter(location.href, 'start', start.format('YYYY-MM-DD'))
                url = updateQueryStringParameter(url, 'end', end.format('YYYY-MM-DD'))
                location.href = url
            }
        );
        ...
        // setInterval(() => console.log(document.currentScript), 2000);

        //     console.log(params)
        $('.daterange-ranges span').html(moment(params.start_date).format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + moment(params.end_date).format('MMMM D, YYYY'));
    };

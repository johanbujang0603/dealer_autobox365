...
var StatisticWidgets = function() {
    ...
    return {
        init: function() {
            ...
            // _barChartWidget("#chart_bar_inventories", 24, 50, true, "elastic", 1200, 50, "#EF5350", "members");
            // _barChartWidget("#chart_bar_leads", 24, 50, true, "elastic", 1200, 50, "rgba(255,255,255,0.75)", "members");
            // _barChartWidget("#chart_bar_customers", 24, 50, true, "elastic", 1200, 50, "rgba(255,255,255,0.75)", "members");
            // _barChartWidget("#chart_bar_transactions", 24, 50, true, "elastic", 1200, 50, "rgba(255,255,255,0.75)", "members");
...
//
            ...
            _animatedDonutWithLegend("#inventories_by_type", 120, inventory_by_type);
            _animatedDonutWithLegend("#leads_by_status", 120, leads_by_status);
            _animatedDonutWithLegend("#leads_by_tags", 120, leads_by_tag);
            // _animatedDonutWithLegend("#leads_by_channels", 120);
